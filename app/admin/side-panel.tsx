    ...
    >
      <ul className="flex flex-col w-full gap-1">
        {routes.map((route, index) => (
          <li
            key={index}
            className="transition-colors p-2 hover:bg-background hover:shadow-md dark:hover:bg-secondary rounded-md cursor-pointer aria-[current]:bg-background aria-[current]:shadow-md aria-[current]:font-semibold dark:aria-[current]:bg-secondary"
